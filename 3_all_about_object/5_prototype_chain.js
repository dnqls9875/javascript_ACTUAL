...
const yuJin4 = new IdolModel2("안유진", 2003);
const wonYoung2 = new IdolModel2("장원영", 2002);

console.log(yuJin4.sayHello());
console.log(wonYoung2.sayHello());

console.log(yuJin4.sayHello === wonYoung2.sayHello); // false

console.log(yuJin4.hasOwnProperty("sayHello"));
...
// static method 적용하는 법 그냥 IdolModel3.붙혀서 작성하면 된다. 왜? 객체이니깐
...
const yuJin5 = new IdolModel4("안유진", 2003);

// 프로퍼티 셰도잉 = clss에서 override
