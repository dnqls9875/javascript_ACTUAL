...
/**
 * 일반함수로 this 키워드를 실행하면 전역객체를 바인딩한다. window
 */
...
/**
 * 1) call -> , 콤마를 기반으로 아규먼트(인수)를 순서대로 넘겨주고
 * 2) apply -> 아규먼트(인수)를 리스트로 입력해야 한다.
 */
...
/**
 * bind() -> this를 바인딩 해놓고 나중에 실행할 수 있다.
 */

const laterFunc = multiply.bind(yuJin3, 3, 4, 5);
console.log(laterFunc); // bound multiply (bind의 과거형 bound)
